...
export default function HomePage() {
  ...
  return (
    <div className="min-h-[calc(100vh-200px)] flex flex-col items-center justify-center text-center space-y-12">
      {/* Hero section */}
      <div className="space-y-6 max-w-3xl animate-slide-in-up">
        <div className="space-y-4">
          <h1 className="text-5xl sm:text-7xl font-black tracking-tighter leading-tight">
            ...
            <br />
            <span className="text-white">but never say</span>
            <br />
            <span className="text-white/70">out loud 💭</span>
          </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <button
            ...
            className="relative group px-8 py-4 rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-cyan-400 text-black font-bold text-lg shadow-xl shadow-purple-500/30 hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105 overflow-hidden"
          >
          ...
          <button
            onClick={() => router.push("/moments/create")}
            className="px-8 py-4 rounded-full glass font-semibold text-base hover:bg-white/15 transition-all duration-300"
          >
            See Examples
          </button>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 pt-12 w-full max-w-2xl px-4">
        {[
          ...
          <div key={i} className="glass rounded-xl p-4 space-y-2 hover:bg-white/12 transition border border-white/8">
            <div className="text-3xl">{stat.emoji}</div>
            <div className="text-2xl font-bold text-transparent bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text">
              {stat.value}
            </div>
      ...
      <div className="glass rounded-xl px-6 py-4 max-w-2xl border border-white/8 backdrop-blur-xl">
        <p className="text-sm text-white/70 leading-relaxed">
          <span className="block font-semibold text-white/90 mb-1">We get it.</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-2xl px-4 pt-8">
        {[
          {
          ...
          <div key={i} className="glass rounded-lg p-4 border border-white/8 text-left">
